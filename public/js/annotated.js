 ...
 *
 */
config.$inject = ["$stateProvider", "$urlRouterProvider", "$ocLazyLoadProvider", "IdleProvider", "KeepaliveProvider"];
            ...
            resolve: {
                loadPlugin: ["$ocLazyLoad", function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            serie: true,
                            files: ['js/plugins/iranmap/iranmap.min.js', 'css/plugins/iranmap/iranmap.min.css']
                        }
                    ]);
                }]
            }
...
function dropZone() {
    return function(scope, element, attrs) {
        var maxFilesize = (attrs.maxSize) ? attrs.maxSize : 1;
        var acceptedFiles = (attrs.fileTypes) ? attrs.fileTypes : 'image/*,.xls,.csv';
        element.dropzone({
            url: attrs.action,
            ...
            sending: function(file, xhr, formData){
                formData.append("_token", $('[name=_token').attr('value'));
            },
            success: function(upload, res){
                scope.$root.$broadcast('fileUploaded', res);
                return true;
            }
        });
    }
...
angular
	.module('inspinia')	
	.factory('userIdFactory', ["$rootScope", "$http", "$state", function($rootScope, $http, $state){
		$rootScope.user = {};
...
modalDemoCtrl.$inject = ["$scope", "$modal"];
wizardCtrl.$inject = ["$scope", "$rootScope"];
CalendarCtrl.$inject = ["$scope"];
GoogleMaps.$inject = ["$scope"];
ngGridCtrl.$inject = ["$scope"];
codeEditorCtrl.$inject = ["$scope"];
nestableCtrl.$inject = ["$scope"];
notifyCtrl.$inject = ["$scope", "notify"];
translateCtrl.$inject = ["$translate", "$scope"];
imageCrop.$inject = ["$scope"];
diff.$inject = ["$scope"];
idleTimer.$inject = ["$scope", "Idle", "notify"];
liveFavicon.$inject = ["$scope"];
formValidation.$inject = ["$scope"];
agileBoard.$inject = ["$scope"];
draggablePanels.$inject = ["$scope"];
sweetAlertCtrl.$inject = ["$scope", "SweetAlert"];
selectCtrl.$inject = ["$scope"];
toastrCtrl.$inject = ["$scope", "toaster"];
loadingCtrl.$inject = ["$scope", "$timeout"];
datatablesCtrl.$inject = ["$scope", "DTOptionsBuilder"];
truncateCtrl.$inject = ["$scope"];
touchspinCtrl.$inject = ["$scope"];
...
function translateCtrl($translate, $scope) {
    $scope.changeLanguage = function (langKey) {
        var rtlFile = 'css/rtl.css';
        $translate.use(langKey);
        $scope.language = langKey;
        if(langKey == 'fa'){
            jQuery('#rtlLanguageStyle').attr('href', rtlFile);
        } else {
            jQuery('#rtlLanguageStyle').attr('href', '');
        }
    };
}
...
angular
	.module('inspinia')
	.controller('createLineController', ["$scope", function($scope){
		$scope.createLineURL = 'lines';
		console.log($scope.createLineURL)
	}]);
angular
	.module('inspinia')
	.controller('createPermissionGroupsController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')	
	.controller('creditController', ['$scope', '$rootScope', function($scope, $rootScope){
		$scope.user_id = 4;
		$scope.changeCreditURL = "users/credit/" + $scope.user_id;
		$scope.creditURL = "api/users/credit/" + $scope.user_id;
	}]);
angular
	.module('inspinia')
	.controller('editLineController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('editPermissionGroupsController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	...
	.controller('ajaxFormController', [
		...
		'$element', 
		'initialsFactory',
		function($scope, $rootScope, $http, $attrs, $element, initialsFactory){
			...
			this.submit = function(e){
				...
				if($rootScope.sendOnRootScope){
					$scope.info.sendOn = $rootScope.sendOnRootScope;
				}
				$http({
					method: method,
					url: url,
...
angular
	.module('inspinia')
	.controller('linesController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
		$scope.lines = [];
		$http({
			method: 'get',
			url: 'lines'
...
angular
	.module('inspinia')
	.controller('permissionGroupsController', ["$scope", "$http", "DTOptionsBuilder", "SweetAlert", "$filter", function($scope, $http, DTOptionsBuilder, SweetAlert, $filter){
		$http({
			method: 'get',
...
angular
	...
	.controller('profileController', ['$scope', '$rootScope', '$http', function($scope, $rootScope, $http){
		$rootScope.$watch('user', function(userId){
			$scope.changePasswordURL = "users/profile/" + userId + "?type=password";
			$scope.changeBirthdayURL = "users/profile/" + userId + "?type=birth";
			$scope.changeInfoURL = 'users/profile';
			$scope.info = $rootScope.user;
		});
...
angular
	...
	.controller('settingsController', ["$scope", "$rootScope", "$http", function($scope, $rootScope, $http){
		$rootScope.$watch('user', function(userId){
			$scope.changeSettingsURL = "users/setting/" + userId;
		});
...
angular.module('inspinia')
	.controller('userPermissionsController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
		...
		$http({
			...
			$scope.info = res.data.permissions;
...
angular
	.module('inspinia')
	.controller('usersController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
		$http({
			method: 'get',
			url: 'users',
			data: []
...
angular
	.module('inspinia')
	.controller('createAutoreplyController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('editAutoreplyController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('autorepliesController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createBlacklistController', ["$scope", function($scope){
...
angular
	.module('inspinia')
	.controller('editBlacklistController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('blacklistController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createCodereaderController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('editCodereaderController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('codereaderController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createChargesController', ["$scope", function($scope){
...
angular
	.module('inspinia')
	.controller('editChargesController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('chargesController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createContactController', ["$rootScope", "$scope", "$http", "$modal", "SweetAlert", "$filter", function($rootScope, $scope, $http, $modal, SweetAlert, $filter){
...
angular
	.module('inspinia')
	.controller('editContactController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('contactGroupController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('ContactController', ["$rootScope", "$scope", "$http", "$modal", "DTOptionsBuilder", function($rootScope, $scope, $http, $modal, DTOptionsBuilder){
		...
		$scope.selectRow = function(key, number){
	    	if($scope.selectedRows[key]){
	    		$scope.selectedRows.splice(key, 1);
	    		return;
	    	}
	    	$scope.selectedRows[key] = number;
	    }

	    $scope.removeSelected = function(){
	    	for(selected in $scope.selectedRows){
	    		$scope.delete(selected, $scope.contacts[selected].id);
	    	}
	    	$scope.selectedRows = [];
	    }
	    ...
	    $scope.resendSelected = function(){
	    	var numbers = '';
	    	for(selected in $scope.selectedRows){
	    		numbers += $scope.selectedRows[selected] + ',';
	    	}
...
angular
	.module('inspinia')
	.controller('trashContactController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
		...
		$scope.generateChart = function(){
		    var dataset = [
		        {
		            ...
		            grow:{stepMode:"linear"},
		            data: $scope.info.messages_chart,
		            color: "#1ab394",
		            bars: {
		                show: true,
		                align: "center",
		    ...
		    var options = {
		        ...
		        yaxes: [
		            {
		                position: "left",
		                max: $scope.info.messages_chart_max_val,
		                color: "#d5d5d5",
		                axisLabelUseCanvas: true,
		                axisLabelFontSizePixels: 12,
		                axisLabelFontFamily: 'Arial',
...
angular
	.module('inspinia')
	.controller('createFilteringsController', ["$scope", function($scope){
		
		$scope.createFilteringsURL = 'faqs';

	}]);	
angular
	.module('inspinia')
	.controller('editFilteringsController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('filteringsController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createFAQSController', ["$scope", function($scope){
...
angular
	.module('inspinia')
	.controller('editFAQSController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('faqsController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('customizationController', ["$rootScope", "$scope", "$http", function($rootScope, $scope, $http){
...
angular
	.module('inspinia')
	.controller('ourServicesController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('financialReportController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('transactionsController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createFluentCreditController', ["$scope", function($scope){
...
angular
	.module('inspinia')
	.controller('editFluentCreditController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('fluentCreditController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createLanguageController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('editLanguageController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
		...
		$http({
			...
			$scope.items = $scope.info = res.data;
			$scope.info.titleOfLanguage = $scope.key;
...
angular
	.module('inspinia')
	.controller('languagesController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createLinePatternController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('linePatternController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createModuleController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('editModuleController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('moduleController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createNewsController', ["$scope", "$http", function($scope, $http){
		$scope.createNewsURL = 'news';
	}]);	
angular
	.module('inspinia')
	.controller('editNewsController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
		$scope.info = {};
...
angular
	.module('inspinia')
	.controller('showNewsController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
		$http({
			method: 'get',
			url: 'news'
		}).then(function(res){
...
angular
	.module('inspinia')
	.controller('createNumbersBankController', ["$scope", function($scope){
...
angular
	.module('inspinia')
	.controller('numbersBankController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('marketingCodeController', ["$rootScope", "$scope", "$http", function($rootScope, $scope, $http){
		$http({
			url: 'marketing-codes',
			method: 'get'
		}).then(function(res){
...
angular
	.module('inspinia')
	.controller('createPollController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('editPollController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('pollsController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createPostalCodeController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('editPostalCodeController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('postalCodeController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createPreTextController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('editPreTextController', ["$rootScope", "$scope", "$http", "$stateParams", function($rootScope, $scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('preTextController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createOccupationsController', ["$scope", function($scope){
...
angular
	.module('inspinia')
	.controller('editOccupationsController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('occupationsController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createPriceGroupController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('editPriceGroupController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('priceGroupHomeController', ["$scope", "$filter", "$http", "DTOptionsBuilder", "SweetAlert", function($scope, $filter, $http, DTOptionsBuilder, SweetAlert){
...
angular
	.module('inspinia')
	.controller('createPlansController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('editPlansController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('plansController', ["$scope", "$http", "DTOptionsBuilder", "SweetAlert", "$filter", function($scope, $http, DTOptionsBuilder, SweetAlert, $filter){
...
angular
	.module('inspinia')
	.controller('smsReceiversController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
		
		$scope.lines = $scope.editURL = [];
		$scope.editURLID = '';
...
angular
	.module('inspinia')
	.controller('socketController', ["$rootScope", "$scope", function($rootScope, $scope){
		console.log('i');
	}]);	
angular
	.module('inspinia')
...
angular
	.module('inspinia')
	.controller('lineExtensionController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('shopLinesController', ["$scope", "$http", "DTOptionsBuilder", "SweetAlert", "$filter", function($scope, $http, DTOptionsBuilder, SweetAlert, $filter){
...
angular
	.module('inspinia')
	.controller('shopModulesController', ["$scope", "$http", "DTOptionsBuilder", "notify", "$filter", function($scope, $http, DTOptionsBuilder, notify, $filter){
...
angular
	.module('inspinia')
	.controller('shopSpecialsController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('upgradeCreditController', ["$scope", "$http", function($scope, $http){
		
		$scope.upgradeByCodeURL = 'shop/charge/upgrade/code';
		$scope.upgradeByCashURL = 'shop/charge/upgrade/cash';
		$scope.fluentCredits = [];
...
angular
	.module('inspinia')
	.controller('createSpecialsController', ["$scope", function($scope){
...
angular
	.module('inspinia')
	.controller('editSpecialsController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('specialsController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createTransferToEmailController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('editTransferToEmailController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('transferToEmailController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('aboutUsController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('supportFaqController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('supportMarketingCodeController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('onlineSupportController', ["$rootScope", "$scope", "$http", "$stateParams", function($rootScope, $scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('ticketsController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
		...
		$scope.createTicketURL = 'tickets';

		$scope.close = function(key, index){
			$http({
				url: 'tickets/cancel/'+index,
				method: 'delete'
			});
			console.log($scope.tickets['sent'][key].status);
...
angular
	.module('inspinia')
	.controller('sendBrandSMSController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('sendCitySMSController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('sendGenderSMSController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('sendGroupSMSController', ["$rootScope", "$scope", "$http", "$modal", function($rootScope, $scope, $http, $modal){
...
angular
	.module('inspinia')
	.controller('sendInternationalSMSController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('sendMapSMSController', ["$scope", "$http", function($scope, $http){
		...
		jQuery(document).ready(function(){
			$('#IranMap .map .province path').click(function() {
                ...
                if (provinceName) {
                    $('#IranMap .city').html('Ù†Ù…Ø§ÛŒØ´ Ø´Ù‡Ø±Ù‡Ø§ÛŒ Ø§Ø³ØªØ§Ù† ' + provinceName);
        ...
        $scope.sendMessages = function(){
        	$http({
        		...
        		data: {
        			...
        			text: $scope.info.text,
        			sendOn: $scope.info.sendOn,
        			line: $scope.info.line
        		}
        	}).then(function(res){
...
angular
	.module('inspinia')
	.controller('sendOccupationSMSController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('sendPostalCodeSMSController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('receivedSMSController', ["$rootScope", "$scope", "$http", "$modal", "DTOptionsBuilder", function($rootScope, $scope, $http, $modal, DTOptionsBuilder){
	...
	.controller('forwardMessageController', ["$rootScope", "$scope", "$http", "$modalInstance", function($rootScope, $scope, $http, $modalInstance){
	...
	.controller('replyMessageController', ["$rootScope", "$scope", "$http", "$modalInstance", function($rootScope, $scope, $http, $modalInstance){
...
angular
	.module('inspinia')
	.controller('reportSMSController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
	    ...
	    $scope.resend = function(key, message){
	    	$http({
	    		method: 'post',
	    		url: 'sms/resend',
	    		data: message
	    ...
	    $scope.selectRow = function(key, index){
	    	if($scope.selectedRows[key]){
	    		$scope.selectedRows.splice(key, 1);
	    		return;
	    	}
	    	$scope.selectedRows[key] = index;
	    }

	    $scope.removeSelected = function(){
	    	for(selected in $scope.selectedRows){
	    		$scope.delete(selected, $scope.messages[selected].id);
	    	}
	    	$scope.selectedRows = [];
	    }
...
angular
	.module('inspinia')
	.controller('sendSingleSMSController', ["$rootScope", "$scope", "$http", function($rootScope, $scope, $http){
...
angular
	.module('inspinia')
	.controller('trashedSMSController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
	    ...
	    $scope.restore = function(key, id){
	    	console.log('sms/restore/'+id);
	    	$http({
	    		url: 'sms/restore/'+id,
	    		method: 'post'
	    	}).then(function(res){
...
angular
	.module('inspinia')
	.controller('userReportController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('adminSettingController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('createContactGroupController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('editContactGroupController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('createPreTextGroupController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('editPreTextGroupController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('preTextGroupController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createDefaultMessagesController', ["$scope", function($scope){
...
angular
	.module('inspinia')
	.controller('editDefaultMessagesController', ["$scope", "$http", "$stateParams", function($scope, $http, $stateParams){
...
angular
	.module('inspinia')
	.controller('defaultMessagesController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
...
angular
	.module('inspinia')
	.controller('createSchedulesController', ["$scope", "$http", function($scope, $http){
...
angular
	.module('inspinia')
	.controller('schedulesController', ["$scope", "$http", "DTOptionsBuilder", function($scope, $http, DTOptionsBuilder){
