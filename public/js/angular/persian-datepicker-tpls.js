...
.controller('ui.bootstrap.persian.datepicker.DatepickerController', ['$rootScope', '$scope', '$attrs', '$parse', '$interpolate', '$timeout', '$log', 'dateFilter', 'datepickerConfig', 'PersianDateService', 'persianDateFilter',
...
.directive('multiDatepicker', function() {
    return {
        restrict: 'EA',
        replace: true,
        templateUrl: '/app/admin/ngApp/templates/libsView/persianDatepicker/datepicker.html',
        scope: {
            datepickerMode: '=?',
            dateDisabled: '&',
        },
...
.directive('singleDatepicker', function() {
    return {
        restrict: 'EA',
        replace: true,
        template: '/app/admin/ngApp/templates/libsView/persianDatepicker/datepicker.html',
        scope: {
            datepickerMode: '=?',
            dateDisabled: '&'
        },
        ...
        link: function(scope, element, attrs, ctrls) {
            var datepickerCtrl = ctrls[0],
                ngModelCtrl = ctrls[1];
            scope.binder = attrs['binder'];
            console.log(scope.binder);
...
.directive('persianDaypicker', ['dateFilter', 'PersianDateService', 'persianDateFilter',
    function(dateFilter, PersianDateService, persianDateFilter) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: '/app/admin/ngApp/templates/libsView/persianDatepicker/day.html',
...
.directive('persianMonthpicker', ['dateFilter', 'PersianDateService', 'persianDateFilter',
    function(dateFilter, PersianDateService, persianDateFilter) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: '/app/admin/ngApp/templates/libsView/persianDatepicker/month.html',
            require: ['?^multiDatepicker', '?^singleDatepicker'],
            link: function(scope, element, attrs, ctrls) {
                if (ctrls[0]) {
                    ctrl = ctrls[0];
...
.directive('persianYearpicker', ['dateFilter', 'PersianDateService', 'persianDateFilter',
    function(dateFilter, PersianDateService, persianDateFilter) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: '/app/admin/ngApp/templates/libsView/persianDatepicker/year.html',
            require: ['?^multiDatepicker', '?^singleDatepicker'],
            link: function(scope, element, attrs, ctrls) {
                if (ctrls[0]) {
                    ctrl = ctrls[0];
...
.directive('persianDatepickerPopupWrap', function() {
    return {
        ...
        replace: true,
        transclude: true,
        templateUrl: '/app/admin/ngApp/templates/libsView/persianDatepicker/popup.html',
...
angular.module("/app/admin/ngApp/templates/libsView/persianDatepicker/datepicker.html", []).run(["$templateCache",
    function($templateCache) {
        $templateCache.put("/app/admin/ngApp/templates/libsView/persianDatepicker/datepicker.html",
...
angular.module("/app/admin/ngApp/templates/libsView/persianDatepicker/day.html", []).run(["$templateCache",
    function($templateCache) {
        $templateCache.put("/app/admin/ngApp/templates/libsView/persianDatepicker/day.html",
...
angular.module("/app/admin/ngApp/templates/libsView/persianDatepicker/month.html", []).run(["$templateCache",
    function($templateCache) {
        $templateCache.put("/app/admin/ngApp/templates/libsView/persianDatepicker/month.html",
            "<table role=\"grid\" aria-labelledby=\"{{uniqueId}}-title\" aria-activedescendant=\"{{activeDateId}}\">\n" +
            "  <thead>\n" +
            "    <tr>\n" +
            "      <th><button type=\"button\" class=\"btn btn-default btn-sm pull-left\" ng-click=\"move(-1)\" tabindex=\"-1\"><i class=\"glyphicon glyphicon-chevron-left\"></i></button></th>\n" +
...
angular.module("/app/admin/ngApp/templates/libsView/persianDatepicker/popup.html", []).run(["$templateCache",
    function($templateCache) {
        $templateCache.put("/app/admin/ngApp/templates/libsView/persianDatepicker/popup.html",
...
angular.module("/app/admin/ngApp/templates/libsView/persianDatepicker/year.html", []).run(["$templateCache",
    function($templateCache) {
        $templateCache.put("/app/admin/ngApp/templates/libsView/persianDatepicker/year.html",
            "<table role=\"grid\" aria-labelledby=\"{{uniqueId}}-title\" aria-activedescendant=\"{{activeDateId}}\">\n" +
            "  <thead>\n" +
            "    <tr>\n" +
            "      <th><button type=\"button\" class=\"btn btn-default btn-sm pull-left\" ng-click=\"move(-1)\" tabindex=\"-1\"><i class=\"glyphicon glyphicon-chevron-left\"></i></button></th>\n" +
